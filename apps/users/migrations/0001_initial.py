    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('student', 'طالب'), ('instructor', 'مدرس'), ('admin', 'إدارة')], default='student', max_length=20, verbose_name='نوع المستخدم')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('experience_level', models.CharField(choices=[('junior', 'Junior (1-2 ans)'), ('intermediate', 'Intermédiaire (3-5 ans)'), ('senior', 'Senior (5-10 ans)'), ('expert', 'Expert (10+ ans)')], max_length=20, verbose_name='مستوى الخبرة')),
                ('certification', models.TextField(blank=True, verbose_name='الشهادة')),
                ('hourly_rate', models.DecimalField(blank=True, decimal_places=2, max_digits=8, null=True, verbose_name='المعدل بالساعة')),
                ('is_verified', models.BooleanField(default=False, verbose_name='تم التحقق منه')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='instructor_profile', to=settings.AUTH_USER_MODEL, verbose_name='المستخدم')),
            ],
            options={
